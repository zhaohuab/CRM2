...
export function viewLeadShow(leadVisible) {
    ...
    return {
        type: "CONTACTS_LIST_VIEWLEADSHOW",
        payload: { leadVisible }
    };
}
...
export function leadEndShow(leadVisible) {
    return {
        type: "CONTACTS_LIST_LEADENDSHOW",
        payload: { leadVisible }
    };
};
export function leadEndView(leadVisible, leadStep) {
    ...
    return {
        type: "CONTACTS_LIST_LEADENDVIEW",
...
export function leadEndIngShow(leadVisible) {
    return {
        type: "CONTACTS_LIST_LEADINGSHOW",
        payload: { leadVisible }
    };
}
...
export function filesSuccess(file) {
    debugger
    return {
        type: "CONTACTS_LIST_FILESSUCCESS",
        payload: file,
    };
}
...
export function changeVisible() {
    return {
        type: "CONTACTS_LIST_CHANGEVISIBLE"
    };
};
...
export function showForm(visible) {
    ...
    return fetchData("CONTACTS_LIST_SHOWFORM", { visible });
};


export function showFormEdit(visiable){
    return{
        type:'CONTACTS_LIST_SHOWEDITFORM',
        visiable
    }
}
    ...
    return dispatch => {
        reqwest(
            ...
            data => {
                // 
                dispatch(
                    fetchData("CONTACTS_LIST_DELETE", {
                        data: data
                    })
                );
            }
...
export function setEnableState(ids, state, page, searchMap) {
    return dispatch => {
        reqwest(
            ...
            dataResult => {
                dispatch(
                    fetchData("CONTACTS_LIST_GETDATA", {
                        data: dataResult,
                        pagination: page
                    })
                );
    ...
    return dispatch => {
        reqwest(
            ...
            dataResult => {
                ...
                dispatch({
                    type: "CONTACTS_LIST_DETAILENABLESTATE",
                    data: dataResult,
                    pagination: page,
                    state
                });
...
export function getListData(pagination, searchMap) {
    ...
    return dispatch => {
        dispatch(fetchData("CONTACTS_LIST_SAVESEARCHMAP", searchMap));
    ...
    return dispatch => {
        reqwest(
            ...
            data => {
                ...
                dispatch(
                    fetchData("CONTACTS_LIST_GETENUMDATA", {
            ...
            data => {
                ...
                reqwest(
                    ...
                    state => {
                        ...
                        debugger;
                        dispatch({
                            type: "CONTACTS_LIST_SHOWVIEWFORM",
                            visible,
                            data,
                            state
                        });
...
export function hideViewForm(visiable) {
    return fetchData("CONTACTS_LIST_HIDEVIEWFORM", { visiable });
};
            ...
            data => {
                ...
                reqwest(
                    ...
                    result => {
                        ...
                        dispatch({
                            type: 'CONTACTS_VIEWPANEL_PANELLEFT_LIST',
                            index: 2,
                            data: result.data
                        });
                    }
...
export function customerListInfo(data, visiable,select) {
    //debugger
    return {
        type: "CONTACTS_LIST_ICBCDETAILINFO",
        data,
        visiable,
        select
    };
...
export function saveIcbcName(viewData, visiable) {
    ...
    return {
        type: 'CONTACTS_LIST_SAVEICBCNAME',
        viewData,
        visiable
    }
}
...
export function saveIcbcNameCancel(visiable) {
    return {
        type: 'CONTACTS_LIST_SAVEICBCNAMECANCEL',
        visiable
    }
}
...
export function icbcDetailInfo(data, visiable,select) {
    ...
    return {
        type: "CONTACTS_LIST_ICBCINFODETAIL",
        data,
        visiable,
        select
    };
...
export function changeStateFn(visiable) {
    return {
        type: "CONTACTS_LIST_CHANGESTATEEDIT",
        visiable
    };
};
//详情中工商核实
    ...
    return dispatch => {
        reqwest(
            ...
            result => {
               // debugger
                dispatch({
                    type: "CONTACTS_LIST_CLOSEDETAILICBCMODOL",
                    visiable,
                    result
    ...
    return dispatch => {
        reqwest(
            ...
            result => {
               // debugger
                dispatch({
                    type: "CONTACTS_LIST_CLEANVERIFYID",
                    visiable,
                    isIdentified:result.isIdentified
                });
            }
        ...
        if(name){
            reqwest(
                ...
                result => {
                   // debugger
                    dispatch({
                        type: "CONTACTS_LIST_ICBCDETAILMODAL",
                        visiable,
                        data: result.data,
                    });
                }
    ...
    return dispatch => {
        reqwest(
            ...
            state => {
                dispatch({
                    //followState
                    type: "CONTACTS_LIST_FOLLOWSTATECHANGE",
                    state
                });
            }
        );
...
export function modalDetalVisiable(visiable, verifyId) {
    return dispatch => {
        reqwest(
            ...
            result => {
                dispatch({
                    type: "CONTACTS_LIST_MODALDETALSHOW",
                    visiable,
                    data: result.data
                });
            }
...
export function modalDetalVisiableFalse(visiable) {
    return {
        type: "CONTACTS_LIST_MODALDETALHIDE",
        visiable
    };
};
...
export function closeIcbcVisible1(visible) {
    return {
        type: "CONTACTS_LIST_MODALCLOSE1",
        visible
    };
};
    ...
    return dispatch => {
        reqwest(
            ...
            result => {
                debugger
                dispatch({
                    type: "CONTACTS_LIST_NEWEDITTYPE",
...
export function editCardFn(changeData) {
    debugger
    return {
        type: "CONTACTS_LIST_CARDEDITCHANGE",
        data: changeData
    };
};
...
export function assignChangeViewData(viewData) {
    return {
        type: "CONTACTS_VIEWPANEL_ASSIGN_CHANGEVIEWPANEL",
        viewData
    }
}
...
export function getRightPaneltList(id, JoinPagination, index) {
    return dispatch => {
        reqwest(
            ...
            result => {
                dispatch({
                    type: "CONTACTS_VIEWPANEL_PANELRIGHT_LIST",
                    data: result,
                    index
                });
            }
...
export function changeLeftPanel(index) {
    return {
        type: 'CONTACTS_VIEWPANEL_CHANGEPANELLEFT',
        index
    }
}
...
export function setRightPaneltList(data) {
   // debugger;
    return {
        type: 'CONTACTS_VIEWPANEL_PANELLEFT_SETLIST',
        data
    }
}
...
export function delRightPaneltList(id) {
    return {
        type: 'CONTACTS_VIEWPANEL_PANELLEFT_DELLIST',
        id
    }
}
...
export function refContactForm(changeData) {
    return {
        type: "CONTACTS_VIEWPANEL_PANELLEFT_CONTACTSFORM",
        data: changeData
    };
}
...
export function refContactFormAdd(data) {
    return {
        type: "CONTACTS_VIEWPANEL_PANELLEFT_CONTACTSFORMADD",
        data
    };
}
...
export function clearRefContactsForm() {
    return {
        type: "CONTACTS_VIEWPANEL_PANELLEFT_CLEARCONTACTSFORM",
    };
}
...
export function delOpp(ids, pagination) {
    return (dispatch) => {
        reqwest({
            ...
            dispatch({
                type: 'CONTACTS_VIEWPANEL_DELOPP',
                ids
            });
        })
    }
    ...
    return (dispatch) => {
        reqwest(
            ...
            result => {
                ...
                dispatch({
                    type: "CONTACTS_VIEWPANEL_DELCONTACTS",
                    id
                });
            }
        );
