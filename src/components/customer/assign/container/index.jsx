            ...
            <div className='assignment-container'>
                {
                    ...
                    >
                        < CompanyAssign headerBtnsClose = {this.headerBtnsClose.bind(this)}/> 
                    </HeaderButton>:
                    <div className='container-header'>
                        <Row className='container-header-show' type='flex' justify='space-between'>
                            ...
                            <Row type='flex' align='middle' gutter={15} style={{height:'54px'}}>
                                ...
                                </Col>
                                {
                                    ...
                                    <Col span={20} >
                                       <LessForm formRedux={this.formRedux.bind(this)} visiable={this.changeSearchVisiable.bind(this)} searchForm={this.searchForm.bind(this)}/>
                                    </Col>
                                }
                            </Row>
                            </Col>
                        ...
                        </Row>
                        {
                            ...
                            <div className='container-header-hide'>
                                <div className='inner'>
                                    <MoreForm  formRedux={this.formRedux.bind(this)} visiable={this.changeSearchVisiable.bind(this)} searchForm={this.searchForm.bind(this)}/>
                                </div>
                            </div>:''
                        }
                    </div>
