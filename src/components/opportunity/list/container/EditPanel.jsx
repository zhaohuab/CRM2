        ...
        this.formRef.props.form.validateFields((err, values) => {
            if (!err) {
                if (this.props.isEdit) {
                    const detail = this.refs.table.getTableData()
                    values.childList = detail;
                    this.props.btnSave(values, this.props.isEdit);
                } else {
                    const detail = this.refs.table.getTableData()
                    values.childList = detail;
                    this.props.btnSave(values, this.props.isEdit);
                ...
                <Row className="view-warrper-header">
                    <Row>
                        ...
                        <Col span={9} className="customer-btn">
                            <Button
                                onClick={this.formHandleOk.bind(this)}
                            >
                                <i className="iconfont icon-bianji" />保存
                            </Button>
                            <Button
