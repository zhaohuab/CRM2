...
class ViewPanel extends React.Component {
    ...
    render() {
        let {viewData,icbcSelect2,icbcVisible2,icbcInfo1,assignList,assignVisiable,assignPersonList,detailFilds,relationObject} = this.props.$$state.toJS();
        let defaultList = [
            {
                uid: -1,
                name: "xxx.png",
                            ...
                            <div className="main-left-inner collapse-recover tab-recoverd">
                                <Tabs defaultActiveKey="1">
                                    <TabPane tab="详情" key="1">
                                        <DetailObject viewData={viewData} detailFilds={detailFilds}/>
                                    </TabPane>
                                    <TabPane tab="相关" key="2">
                                        <RelevantObject relationObject={relationObject}/>
                                    </TabPane>
