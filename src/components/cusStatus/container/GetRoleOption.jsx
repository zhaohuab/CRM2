...
const getOption = (data) =>{
    ...
    let center = dataSource.flag=='country'?[104.114129, 37.550339]:geoCoordMap[dataSource.name];
    //***********注意：获取center时，仅仅是geoCoordMap中含有的省市才可以，如果没有就会报错，现在geoCoordMap里面市不全，无县区
    let option = {
